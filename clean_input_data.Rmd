...
Create folders for storing script outputs. Note: the "files" folder should already exist and contain Data S1-3
```{r }
...
#  dir.create("rdata")
#}
if (!file.exists("supplementary_tables")) {
  dir.create("supplementary_tables")
}
if (!file.exists("figs")) {
  dir.create("figs")
}
...
export_heatmap_png(filename = "figs/qc_prot_cohort2_outlier", width = 25, height=5, ht_object=ht)
...
export_heatmap_png(filename = "figs/qc_prot_batchcorr", width = 15, height=8, ht_object=ht)
