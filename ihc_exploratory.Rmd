...
discrete_heatmap_annot_reordered_noend$tumor_id2 = paste(discrete_heatmap_annot_reordered_noend$patient,
                                                         discrete_heatmap_annot_reordered_noend$sample_group,
                                                         sep="_")


circlize_plot = function() {
  circos.par(start.degree = 90, gap.degree = c(rep(0.8,4),3, #112
                                               rep(0.8,2),3, #155
                                               rep(0.8,5),3, #156
                                               rep(0.8,2),3, #157
                                               rep(0.8,6),3, #158
  ...
  circos.heatmap(discrete_heatmap_annot_reordered_noend$group2, 
                 split= discrete_heatmap_annot_reordered_noend$tumor_id2,
                 col = colorlist$ihc_subtype, track.height = 0.10,
                 show.sector.labels = TRUE)
 # circos.text(discrete_heatmap_annot_reordered_noend$tumor_id2, 1, nm, facing = "clockwise", adj = c(0, 0.5))
  #https://github.com/jokergoo/circlize/issues/304
